    ...
    <div className="min-h-screen w-full bg-gray-100 flex flex-col">
      ...
      <header className="w-full bg-white shadow-md p-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-3 mt-4 md:mt-0">
          { pathname!=='/dashboard/employee/upload_screenshot' &&<button
            onClick={() => router.push('/dashboard/employee/upload_screenshot')}
          ...
          {pathname !== '/dashboard/employee/own_screenshot_show'
            && !pathname.includes('show_screenshot')
            && <button
                      onClick={() => router.push('/dashboard/employee/own_screenshot_show')}
